                ...
                if type_ == -1:  # creature
                    ...
                    if len(infos) == 12:
                        self.entity_gestion.add_entity(
                            Entity('Mob', cell=cell, id=entity_id, template=template, pa=infos[12], vie=infos[13],
                                   pm=infos[14]))
                    else:
                        self.entity_gestion.add_entity(
                            Entity('Mob', cell=cell, id=entity_id, template=template, pa=None, vie=None, pm=None))
                    ...
                    self.entity_gestion.add_entity(
                        Entity('GroupMob', cell=cell, id=entity_id, templates=templates, levels=levels))
                elif type_ == -4:  # NPC
                    ...
                    if entity_id != int(self.character.id_):
                        self.entity_gestion.add_entity(
                            Entity('Player', cell=cell, id=entity_id, name=infos[4], pa=None, vie=None, pm=None))
                    else:
                        self.entity_gestion.add_entity(
                            Entity('Player', cell=cell, id=entity_id, name=infos[4], isMainCharacter=True, pa=None,
                                   vie=None, pm=None))
